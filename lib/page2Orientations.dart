...
class Page2Portrait extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _Page2PortraitState();
  }
}

class _Page2PortraitState extends State<Page2Portrait> {
  double pajamos = 0;
  int sanauduTipas = 1;
...
class Page2Landscape extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _Page2LandscapeState();
  }
}

class _Page2LandscapeState extends State<Page2Landscape> {
  double pajamos = 0;
  int sanauduTipas = 1;
  double sanaudos = 0.0; // custom or 0.3
  double taikomasGPM = 0.15;
