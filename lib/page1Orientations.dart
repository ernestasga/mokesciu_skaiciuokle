...
class Page1Portrait extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _Page1PortraitState();
  }
}

class _Page1PortraitState extends State<Page1Portrait> {
...
class Page1Landscape extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _Page1LandscapeState();
  }
}

class _Page1LandscapeState extends State<Page1Landscape> {
  double NPD = 0.0; // auto, 600, 640
  double pensijosImoka = 0.03; // 0 arba 0.021 arba 0.03
  double darbdavioGrupe = 0.0014; // I 0.0014 II 0.004 III 0.007 IV 0.014
  double sutartiesRusis = 0.0; // neterminuota 0, terminuota 0.0072
